  ...
  let skillsData = [
    {
      ...
      icon: "",
      skills: [
        { name: "TypeScript", level: 85, rank: "S" },
        { name: "React", level: 90, rank: "S" },
        { name: "Svelte", level: 80, rank: "A" },
        { name: "CSS/Tailwind", level: 88, rank: "S" },
      ],
    },
    {
      category: "Backend",
      icon: "",
      skills: [
        { name: "Node.js", level: 85, rank: "S" },
        { name: "Python", level: 75, rank: "A" },
        { name: "Go", level: 60, rank: "B" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "CI/CD", level: 70, rank: "A" },
        { name: "AWS", level: 65, rank: "B" },
      ],
    },
    {
      category: "Database",
      ...
      skills: [
        ...
        { name: "MongoDB", level: 70, rank: "A" },
        { name: "Redis", level: 68, rank: "B" },
      ],
    },
  ];
